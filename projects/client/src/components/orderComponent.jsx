...
const OrderComponent = ({ status, invoice, total, date, details, store }) => {
            ...
            <div className="border p-3 rounded-xl border-green-700 border-l-8 hover:border-b-4 ease-in duration-200">
                <div className="w-full lg:flex lg:justify-between ">
                    <div>
                        ...
                        <div className="lg:flex-1 lg:grid lg:place-content-center  p-2 ">{store}</div>
                    </div>
                    ...
                    <div className="lg:flex-1 lg:grid lg:place-content-center">{details}</div>
