...
const OrderComponent = ({ status, invoice, total, date, details, store, image, productName, quantity }) => {
    ...
    return (
        <div>
            <div className="border p-3 rounded-xl border-green-700 border-l-8 hover:border-b-4 ease-in duration-200 w-full">
                <div className=" justify-between ">
                    ...
                    <div>
                        ...
                        <div className="lg:flex lg:justify-between">
                            <div className="flex">
                                <div className=" h-[80px] w-[80px] lg:h-[100] lg:w-[120px]">
