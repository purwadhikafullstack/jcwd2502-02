    ...
    return (
        <div>
            <div className=" card flex flex-col justify-between w-[109px] flex-none font-bold ease-in duration-200 gap-3">
                <button className={`grid place-content-center h-[105px] w-[105px] border-4 border-white rounded-full hover:shadow-xl hover:shadow-yellow-200 hover:scale-105 ease-in duration-200 ${props.style}`}
